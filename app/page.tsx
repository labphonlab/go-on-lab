...
export default function GoOnLabApp() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-6 font-sans text-slate-100 relative">
      ...
      <div className={`max-w-md w-full transition-all duration-500 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <div className="p-8">
            {step === 'start' && (
              <div className="text-center py-4">
                <h2 className="text-xl font-bold mb-4 italic text-emerald-400">"Go on to your goal."</h2>
